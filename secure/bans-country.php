...
<div class="content-wrapper" style="margin-top: 0px!important;background-color: #1b1d1e;">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 "><i class="fas fa-globe"></i> Ülke Ban</h1>
        		    </div>
        		    <div class="col-sm-6">
        		      <ol class="breadcrumb float-sm-right">
        		        <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Admin Panel</a></li>
        		        <li class="breadcrumb-item active">Ülke Ban</li>
        		      </ol>
        		    </div>
        		  </div>
    			</div>
...
if (isset($_POST['add-country'])) {
    ...
    if ($redirect == 1 and $url == NULL) {
		...
		<div class="callout callout-danger">
                <p><i class="fas fa-exclamation-triangle"></i> Lütfen yasaklı ülkeden tüm ziyaretçilerin yönlendirileceği bir bağlantı girin.</p>
        </div>';
    } else {
		...
		<div class="callout callout-info">
                <p><i class="fas fa-info-circle"></i> This <strong>Ülke </strong> zaten ekli</p>
        </div>';
        } else {
 ...
 <form class="form-horizontal" action="" method="post">
                    <div class="card card-primary card-outline">
						<div class="card-header">
							<h3 class="card-title">Düzelt - Ülke Ban</h3>
						</div>
						<div class="card-body">
...
<option value="Unknown">Unknown</option>
                                        ...
                                        <div class="form-group">
											<label class="control-label">Sayfaya / siteye yönlendirme: </label>
...
?>>Yes</option>
                                        ...
                                        <div class="form-group">
											<label class="control-label">Yönlendirme Adresi: </label>
...
?>
				    ...
				    <div class="card card-primary card-outline">
						<div class="card-header">
							<h3 class="card-title">Ülke Ban</h3>
						</div>
						<div class="card-body">
...
<option value="Unknown">Unknown</option>
                                        ...
                                        <div class="form-group">
											<label class="control-label">Sayfaya / siteye yönlendir: </label>
	<select name="redirect" class="form-control" required>
        ...
        <option value="1">Evet</option>
                        ...
                        <div class="card-footer">
							<button class="btn btn-flat btn-danger btn-block" name="add-country" type="submit">Ekle</button>
				        </div>
				     </div>
</form>
				</div>
